...
const api: AxiApi = {
  ...
  setGameAudioEnabled: (enabled) => ipcRenderer.invoke(CH.setGameAudioEnabled, enabled) as Promise<void>,
  setGameAudioTarget: (target) => ipcRenderer.invoke(CH.setGameAudioTarget, target) as Promise<void>,
